...
it("should render one event", () => {
    ...
    const singleEvent = {
        ...
        "guid": {
            "rendered": "https://central.wordcamp.org/wordcamps/wordcamp-wordcamp-pakistan-online/"
        },
        "modified": "2021-02-14T19:08:44",
        "modified_gmt": "2021-02-15T00:08:44",
        "slug": "wordcamp-pakistan-online",
        "status": "wcpt-closed",
        "type": "wordcamp",
        "link": "https://central.wordcamp.org/wordcamps/wordcamp-pakistan-online/",
        "title": {
            "rendered": "WordCamp pakistan (Online)"
        },
        "content": {
            "rendered": "<p><span style=\"font-weight: 400\">We are happy to announce that communities across pakistan are joining hands to organize the first ever edition of WordCamp pakistan Online from January 30 to February 14. </span><span style=\"font-weight: 400\">Yes! You read those dates right. <strong>We plan to have our WordCamp over three weekends! </strong></span></p>\n<p><span style=\"font-weight: 400\">We are planning a unique event that has something for everyone at the same time we do not want to try to simulate a traditional in-person event in an online space. </span><span style=\"font-weight: 400\">Since WordCamp pakistan 2021 is a fully online event, anyone from any part of the world would be able to attend. Tickets for the event will be completely free! All you need is a computer or a smartphone with an internet connection to participate in the event.</span></p>\n<p>Come, join us!</p>\n",
            "protected": false
        },
        "author": 3201356,
